...
function SideBar() {
  ...
  const openDrawer = () => {dispatch(handleOpen(true));};
  ...
  return (
    ...
    <Card className="flex flex-col items-start h-full w-full rounded-none " 
        shadow={false}>
        <CardBody className="p-0 w-full mx-auto">
          <div className="my-1 p-2 mx-2 flex flex-col justify-between items-center h-full">
            <div className={`hidden lg:flex items-center justify-center px-4 py-3 rounded-md my-1 cursor-pointer border-b-2`}>
              <ListItemPrefix className="mx-auto">
              <FaArrowRightFromBracket className="w-6 h-6 cursor-pointer text-black" role="button" onClick={() => openDrawer()} />
              </ListItemPrefix>
            </div>
            ...
            <div className={`hidden lg:flex items-center justify-center px-4 py-3 rounded-md my-1 cursor-pointer`}
    ...
    <Drawer open={open} onClose={closeDrawer} >
      <Card className="flex flex-col justify-between items-start h-full w-full" 
        shadow={false}>
        <CardHeader 
        shadow={false}
        floated={false}
        className="flex flex-col w-full m-0">
          <div className="flex items-center border-b-2 mt-4 p-4 cursor-pointer hover:bg-blue-gray-50 rounded-xl"
          onClick={() => navigate("/profile")}>
        ...
        <CardBody className="p-0 w-full">
          <div className="mt-2 p-2  border-b-2 mx-2">
            <div className={`flex items-center px-2 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/feed"); closeDrawer()}}>
              <ListItemPrefix>
              <IoImages className="w-6 h-6" />
              </ListItemPrefix>
            ...
            <div className={`flex items-center px-2 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/jobs"); closeDrawer()}}>
              <ListItemPrefix>
              <BsPersonWorkspace className="w-6 h-6" />
              </ListItemPrefix>
            ...
            <div className={`flex items-center px-2 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/hire"); closeDrawer()}}>
              <ListItemPrefix>
              <FaBriefcase className="w-6 h-6" />
              </ListItemPrefix>
            ...
            <div className={`flex items-center px-2 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/connections"); closeDrawer()}}>
              <ListItemPrefix>
              <FaUserFriends className="w-6 h-6" />
              </ListItemPrefix>
            ...
            <div className={`flex items-center px-2 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/postajob"); closeDrawer()}}>
              <ListItemPrefix>
              <FaSquarePlus className="w-6 h-6" />
              </ListItemPrefix>
          ...
          <div className="mt-2 p-2">
            <div className={`flex items-center px-4 py-3 rounded-md my-1 hover:bg-blue-gray-50 cursor-pointer`}
            onClick={() => {navigate("/settings"); closeDrawer()}}>
              <ListItemPrefix>
              <FaGear className="w-6 h-6" />
              </ListItemPrefix>
