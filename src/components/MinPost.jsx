...
const MinPost = () => {
  ...
  return (
    <Card className="w-full bg-inherit h-2/3 flex-col items-center mx-auto mt-5 shadow-md lg:flex hidden overflow-hidden">
      <Card className="w-full flex items-center justify-center bg-white rounded-md mb-3">
      ...
      <div className="overflow-y-scroll scrollbar-thin w-full h-full flex flex-col items-center overflow-x-hidden gap-3">
        {posts.map((post, key) => (
          <MinPostCard
            post={post}
            key={key}
