...
const MaxJob = () => {
  return (
    <div className="w-11/12 flex flex-col md:w-2/4 mx-auto mt-6 py-2 bg-white">
      <div className="w-full flex flex-col border-b-2 pb-2">
        <div className=" flex flex-col md:flex-row items-center px-2 md:px-5 justify-between">
          <div className="w-full md:w-3/5 md:mr-4 flex items-center">
            <input
              className="relative w-full border-2 border-gray-400 px-3 py-1 rounded-full md:mx-4"
