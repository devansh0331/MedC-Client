...
const MaxJob = () => {
  return (
    <div className="w-11/12 flex flex-col md:w-4/5 xl:w-2/5 mx-auto mt-6 py-1 bg-white rounded-md shadow-md">
      <div className="w-full flex flex-col">
        <div className=" flex flex-col md:flex-row md:items-center px-2 md:px-5 justify-between">
          <div className="w-full md:w-4/5 md:mr-4 flex items-center">
            ...
            <button className="w-1/5 text-sm md:text-md border-primary border-2 bg-primary text-white my-2 px-2 justify-center py-1 rounded-full flex items-center">
