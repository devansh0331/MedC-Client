...
const ProfilePage = () => {
  ...
  return (
    <div className='w-full h-screen bg-background overflow-hidden relative'>
        ...
        {closeAbout ? <EditAbout closeAbout={closeAbout} setCloseAbout={setCloseAbout}/> : ''}
      <div className="w-3/5 mx-auto flex justify-around pt-20">
        <div className="mx-2 items-center flex flex-col">
        <ProfileCard setClose={setClose} route="profile"/>
        <button className='mx-auto text-white bg-primary px-3 py-1 rounded-full my-4 hover:bg-background hover:border-2 hover:border-primary hover:text-primary'>Download Resume</button>
        </div>
        <div className="mx-2">
