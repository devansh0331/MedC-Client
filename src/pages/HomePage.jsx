  ...
  return (
    <div className="w-full h-full flex flex-col box-border overflow-x-hidden">
      ...
      <div className="flex flex-col justify-evenly mt-20 mb-20 m-auto items-center">
        <h1 className=" text-3xl md:text-4xl text-center mb-14 font-semibold">
          Why <span className="text-primary">MedC?</span>
        </h1>
        <div className="flex lg:flex-row flex-col justify-center items-center">
          <div className="flex md:flex-row flex-col justify-center items-center w-full">
            <div className="lg:w-full md:w-2/5 w-10/12 flex flex-col items-center  p-5">
              <div
                className="xl:w-2/3 h-full flex flex-col justify-evenly items-center border-2 border-gray-200 rounded-3xl shadow-md p-4 hover:scale-110 hover:shadow-lg"
      ...
      <div className="w-full my-10" id="jobs">
        <div className="w-full h-96 flex sm:flex-row flex-col px-3 sm:justify-start sm:items-start justify-center items-center">
          <div className="sm:w-1/2 h-72 md:justify-end flex rounded-3xl justify-center">
            <img
              src={jobs}
              alt="job"
              className="w-2/3 sm:w-11/12 md:w-3/5 sm:mr-5 object-cover rounded-3xl "
            />
          </div>
          <div className=" text-center sm:text-left sm:ml-5 ">
            <p className="text-3xl md:text-4xl lg:text-5xl leading-custom mt-3">
              Search yourself <br />
              <span className=" text-primary sm:text-white">The Best Jobs</span>
            </p>
            <p className="text-gray-800">
              Get your dream job at your dream location.
              <br />
              Connect with up to date medical world.
            </p>
            <button
              className="bg-blue1 border-2 py-2 px-3 md:px-6 mt-8 rounded-full text-base md:text-lg text-white hover:bg-white hover:text-primary"
              style={{ transition: "all 0.3s" }}
        ...
        <div className="w-full mx-auto justify-center sm:items-start items-center h-96 flex sm:flex-row flex-col mt-20 sm:-mt-24 px-3">
          <div className="text-center sm:text-right sm:mr-5 w-1/2 self-right order-last sm:order-first">
            <p className="text-3xl md:text-4xl lg:text-5xl leading-custom">
              Find A <br />
              <span className="text-primary sm:text-white">Professional</span>
            </p>
            <p className="text-gray-800">
              Find a perfect suit for the job openings
              <br /> in your business
            </p>
            <button
              className="bg-blue1 border-2 py-2 px-3 md:px-6 mt-8 rounded-full text-base md:text-lg text-white hover:text-primary hover:bg-white hover:border-primary "
              style={{ transition: "all 0.3s" }}
          ...
          <div className="sm:w-1/2 h-72 justify-center sm:justify-start flex rounded-3xl">
            <img
              src={professional}
              alt="professional"
              className="w-2/3 sm:w-11/12 md:w-3/5 sm:ml-5 object-cover rounded-3xl"
            />
          </div>
        </div>
      </div>
