        ...
        <div className="min-[1050px]:w-4/6 lg:w-5/6 w-full m-auto mt-20 mx-2">
          <div className="search">
            <Navbar className="flex flex-row" fullWidth shadow>
              ...
              <Button size="sm" variant="outline" className="md:px-4 p-2 md:rounded-lg rounded-full  max-[768px]:w-8 max-[768px]:h-8 max-[768px]:mx-auto max-[768px]:ml-2">
                <span className="md:hidden"><IoMdSearch className="w-4 h-4"/></span>
            ...
            <Card className="Connections my-2 flex flex-row p-4">
              ...
              >
                <div className="flex flex-row gap-3 items-center">
                  <Avatar src={altprofile} alt="profile" size="lg" className="w-12 h-12 md:w-16 md:h-16"/>
                  <div className="">
              ...
              <CardBody className="p-0 ml-auto">
                <Button
                  ...
                  hover
                > 
                  <span className="md:hidden"><IoPersonAddOutline className="w-4 h-4"/></span>
                  <span className="hidden md:block">Connect</span>
                </Button>
                <Button size="sm" color="light-blue" variant="outlined" className="md:px-4 p-2 md:rounded-lg rounded-full">
                <span className="md:hidden"><ImProfile className="w-4 h-4"/></span>
